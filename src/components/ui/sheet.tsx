...
function SheetContent({
  ...
  /** Merged onto `SheetOverlay` (e.g. tint strength) without copying portal markup. */
  overlayClassName?: string
  /**
   * When true, only the in-content close control dismisses the sheet (not overlay,
   * outside pointer, or Escape). Handlers live here so parent can stay a Server Component.
   */
  preventDismissOnOutside?: boolean
}) {
  const dismissLockProps: Pick<
    React.ComponentProps<typeof SheetPrimitive.Content>,
